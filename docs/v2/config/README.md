...
|template|string|生成路由的模板文件地址。[同crud.contreller.template参数](/v2/config/#crud-controller-的参数)|
...
|template|string|模型生成的模板地址。[同crud.contreller.template参数](/v2/config/#crud-controller-的参数)|
...
|template|string|验证器生成的模板地址。[同crud.contreller.template参数](/v2/config/#crud-controller-的参数)|
|rules|array|可选的验证规则|
...
|template|string|自定义生成的模板地址。[同crud.contreller.template参数](/v2/config/#crud-controller-的参数)|
...
> 或许你会对以上配置里面的 `${app[0].folder}`、`${app[1].folder}`、`${field}` 感到困惑，
