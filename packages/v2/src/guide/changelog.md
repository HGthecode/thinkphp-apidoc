...
> 需升级前端文件 [v1.3.5](https://gitee.com/hg-code/apidoc-ui/attach_files/708194/download/apidoc.zip)
...
> 需升级前端文件 [v1.3.4](https://github.com/HGthecode/apidoc-ui/releases/download/v1.3.4/apidoc.zip)
...
> 需升级前端文件 [v1.3.2](https://github.com/HGthecode/apidoc-ui/releases/download/v1.3.2/apidoc.zip)
